...
const getdistinctitems = (req, res) => {
    ...
    job_challans.accountID = master_account.uid AND job_challan_details.greyItemID = grey_items.itemID and jobType=? and accountID=? and status="0";`,
        [data.jobType, data.accountID],
        (error, result) => {
            if (error) {
