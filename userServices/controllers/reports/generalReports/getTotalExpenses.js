  ...
  try {
    ...
    const expense2 = await connection.execute(
      ...
      const expense3 = await connection.execute(
        `SELECT SUM(totalamount) as general_purchase_expense FROM generalpurchase;`,
      );
    ...
    const ans = {
        ...
        // general_purchase_expense : `${expense3[0][0].general_purchase_expense===null?0:expense3[0][0].general_purchase_expense}`,
