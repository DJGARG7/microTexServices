...
import GetQuantity from "../controllers/GetQuantity.js";
import GetType from "../controllers/GetType.js";
...
router.get("/quantity/:clothType", GetQuantity); // update the data in the table
router.get("/Type/:DName", GetType);
